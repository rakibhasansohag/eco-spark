...
export const IdeaController = {
  ...
  getSimilar: catchAsync(async (req: Request, res: Response) => {
    const result = await IdeaService.getSimilar(req.params.id);
    sendResponse(res, { httpStatusCode: StatusCodes.OK, success: true, message: "Similar ideas fetched", data: result });
  }),
