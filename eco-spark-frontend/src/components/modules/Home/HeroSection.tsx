...
export function HeroSection() {
  return (
    <BeamHoverCard
      className="relative overflow-hidden rounded-xl border bg-gradient-to-br from-background via-primary/5 to-cyan-50/35 px-6 py-14 shadow-[0_8px_30px_-18px_rgba(15,23,42,0.35)] md:px-10 md:py-16"
      intensity={8}
    >
      <section className="relative">
        ...
        <div className="relative max-w-4xl">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <Button variant="secondary" asChild className="h-10 rounded-xl px-5">
